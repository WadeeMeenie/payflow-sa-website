  ...
  return (
    <header className="sticky top-0 z-40 glass px-4 py-3 sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
        <a href="#hero" className="inline-flex min-w-0 items-center gap-2" onClick={closeMenu}>
        ...
        <nav className="hidden items-center gap-5 text-sm font-bold text-muted lg:flex xl:gap-7" aria-label="Primary navigation">
          ...
          <a href="/knowledge/payroll-questions/" className="hover:text-payflow transition-colors">Knowledge</a>
        ...
        <div className="flex items-center gap-2">
          <button
            type="button"
            className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-black/10 text-navy lg:hidden"
      ...
      {menuOpen && (
        <nav className="mx-auto mt-3 max-w-7xl border-t border-black/10 pt-3 lg:hidden" aria-label="Mobile navigation">
          <div className="grid gap-1 text-sm font-bold text-muted">
            ...
            <a href="/knowledge/payroll-questions/" onClick={closeMenu} className="rounded-lg px-3 py-3 hover:bg-black/5">Knowledge</a>
